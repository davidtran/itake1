...
class Comment extends CActiveRecord {
    ...
    const INITIAL_COMMENT_NUMBER = 10;
    ...
    public function relations() {
        ...
        return array(
            ...
            'parentModel' => array(self::HAS_MANY, 'Comment', 'parent_id', 'order' => 'parentModel.create_date DESC', 'limit' => self::INITIAL_COMMENT_NUMBER),
            'childCommentCount' => array(self::STAT, 'Comment', 'parent_id'),
            'product' => array(self::BELONGS_TO, 'Product', 'product_id'),
            //'childCommentList'=>array(self::B,'Comment','parent_id'),
        );
    }
