...
<p><?php echo Yii::t('translatemail','Thank you for becoming a iTake member.');?>:</p>
<p><?php echo Yii::t('translatemail','Now you just need to click the link below and verify your email'); ?></p>
