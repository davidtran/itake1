...
return array(
    ...
    '{number} min|{number} mins'=>'{number} giờ',
    '{number} second|{number} seconds'=>'{number} giờ',
     'year'=>'năm',
     'month'=>'tháng',
     'week'=>'tuần',
     'weeks'=>'tuần',
    ...
    '<b>Warning:</b> The width of your image is larger than 420 pxs and its height is taller than 420 pxs'=>'<b>Lưu ý:</b> Bề ngang ảnh phải lớn hơn 420 pxs và bề cao ảnh phải lớn hơn 420pxs',
    'Change'=>'Thay đổi',
    'Remove'=>'Xóa',
    'Update'=>'Cập nhật',
