...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'processed_image'); ?>
		<?php echo $form->textField($model,'processed_image',array('size'=>60,'maxlength'=>100)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'image_thumbnail',array('rows'=>6, 'cols'=>50)); ?>
	</div>
