...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('fbprofile')); ?>:</b>
	<?php echo CHtml::encode($data->fbprofile); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('isFbUser')); ?>:</b>
	<?php echo CHtml::encode($data->isFbUser); ?>
	<br />
