...
class UserController extends Controller
{
	...
	{
        if(Yii::app()->user->checkAccess(UserRoleConstant::UPDATE_USER_TASK)){
	...
	{
        if(Yii::app()->user->checkAccess(UserRoleConstant::DELETE_USER_TASK)){
	...
	{                
        //Yii::app()->authManager->assign('mod',15);
        if(Yii::app()->user->checkAccess(UserRoleConstant::VIEW_USER_TASK)){
